...
class Driver(db.Model):
    ...
    name = db.Column(db.String(50))                 # ✅ added
    bus_route = db.Column(db.String(20))            # ✅ added
...
def send_otp():
    ...
    try:
        ...
        db.session.rollback()
        app.logger.error(f"OTP ERROR: {e}")
...
def location():
    ...
    try:
        ...
        db.session.rollback()
        app.logger.error(f"LOCATION ERROR: {e}")
